    ...
    <div class="wrapper-content">
        <section class="advantage">
            ...
            <div class="advantage-item">
                <div class="advantage-text">
                    <div class="advantage-title">
                    В чем удобства нашего cервиса для клиента? 
                    </div>
                    <div class="advantage-hr">
                    </div>
                    <div class="advantage-desc tal">
                    В автоматизации услуги и экономии времени! Приобретая тариф в нашем сервисе вы получите автоматическую услугу, позволяющая сэкономить ваше личное время. Также за каждым клиентом у нас закрепляется личный персональный менеджер, с которым вы можете связаться 24/7 
