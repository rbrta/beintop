...
export const LazyAddClientModal = import('../../components/modals/manager/AddClientModal.vue' /* webpackChunkName: "components/modals/manager/AddClientModal" */).then(c => c.default || c)
