            ...
            <div class="item-body">
              <vue-glide :per-view="4" :rewind="false" type="carousel" :breakpoints="glide.breakpoints">
                ...
                <template slot="control">
                  <button data-glide-dir="<" class="glide__arrow glide__arrow--left"><font-awesome-icon icon="long-arrow-alt-left"/></button>
                  <button data-glide-dir=">" class="glide__arrow glide__arrow--right"><font-awesome-icon icon="long-arrow-alt-right"/></button>
                </template>
              </vue-glide>
            </div>
          </div>
